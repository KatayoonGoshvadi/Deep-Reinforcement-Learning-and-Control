...
class DQN_Agent():
	...
	def __init__(self, environment_name, Q_model, render=False, learning_rate=1e-5, gamma=0.99, replay_size=100000, burn_in=20000, save_weights_path=None, replay_mem=None):
